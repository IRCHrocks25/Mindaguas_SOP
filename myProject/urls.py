...
urlpatterns = [
    ...
    path('invite/hr/<uuid:token>/', views.accept_hr_invitation, name='accept_hr_invitation'),
    ...
    path('dashboard/hr/training-status/', dashboard_views.dashboard_hr_training_status, name='dashboard_hr_training_status'),
    path('dashboard/hr/employee/<int:user_id>/', dashboard_views.dashboard_hr_employee_report, name='dashboard_hr_employee_report'),
    path('dashboard/hr/course-email-report/', dashboard_views.dashboard_course_email_report, name='dashboard_course_email_report'),
    path('dashboard/hr/exam-results/', dashboard_views.dashboard_hr_exam_results, name='dashboard_hr_exam_results'),
    path('dashboard/hr/performance-correlation/', dashboard_views.dashboard_performance_correlation, name='dashboard_performance_correlation'),
    path('dashboard/hr/accounts/', dashboard_views.dashboard_hr_accounts, name='dashboard_hr_accounts'),
    path('dashboard/hr/dispatch-reminders/', dashboard_views.dashboard_dispatch_reminders, name='dashboard_dispatch_reminders'),
    path('dashboard/hr/send-digests/', dashboard_views.dashboard_send_hr_digests, name='dashboard_send_hr_digests'),
    path('dashboard/hr/send-course-assignment/', dashboard_views.dashboard_send_course_assignment_email, name='dashboard_send_course_assignment_email'),
